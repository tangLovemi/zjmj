...
function screenChange(isW) {
    cc.log("main.js : screenChange() START");
    ...
    sendEvent("resize");
    cc.log("main.js : screenChange() END");
}
 
cc.game.onStart = function(){
    cc.log("main.js : cc.game.onStart() START");
    ...
    cc.LoaderScene.preload(g_resources, function () {
		jsclient.Scene=new GameScene();
        cc.director.runScene(jsclient.Scene);
    }, this);
    cc.log("main.js : cc.game.onStart() END");
};
cc.game.run();